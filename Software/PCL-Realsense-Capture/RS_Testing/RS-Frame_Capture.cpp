...
int main() {
    ...
    while(captureLoop == true) {
        ...
        */
        /*
        //=========================================
        // Filter PointCloud (VoxelGrid Method)
        //=========================================
        pcl::VoxelGrid<pcl::PointXYZRGB> Cloud_Filter;
        Cloud_Filter.setInputCloud (cloud);
        Cloud_Filter.setLeafSize (0.01f, 0.01f, 0.01f);
        ...
        */
        ...
        /*
        cloud_pointer prevCloud = cloud; // Save previous cloud for stitching
        pcl::io::savePCDFileASCII("Previous_Frame.pcd", *prevCloud); // Input cloud to be saved to .pcd
        cout << "Previous_Frame.pcd successfully generated. " << endl; 
        */
