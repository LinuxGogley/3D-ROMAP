...
class FeatureCloud
{
  public:
    ...
    FeatureCloud () :
      search_method_XYZRGB_ (new SearchMethod),
      normal_radius_ (0.2f),
      feature_radius_ (0.2f)
    {}
    ...
    void
    setInputCloud (PointCloud::Ptr XYZRGB)
    {
      XYZRGB_ = XYZRGB;
      processInput ();
    }
    ...
    {
      XYZRGB_ = PointCloud::Ptr (new PointCloud);
      pcl::io::loadPCDFile (pcd_file, *XYZRGB_);
      processInput ();
    }
  ...
  protected:
    ...
    computeSurfaceNormals ()
    {
      ...
      norm_est.setInputCloud (XYZRGB_);
      norm_est.setSearchMethod (search_method_XYZRGB_);
    ...
    computeLocalFeatures ()
    {
      ...
      fpfh_est.setInputCloud (XYZRGB_);
      fpfh_est.setInputNormals (normals_);
      fpfh_est.setSearchMethod (search_method_XYZRGB_);
  ...
  private:
    // Point cloud data
    PointCloud::Ptr XYZRGB_;
    SurfaceNormals::Ptr normals_;
    LocalFeatures::Ptr features_;
    SearchMethod::Ptr search_method_XYZRGB_;
